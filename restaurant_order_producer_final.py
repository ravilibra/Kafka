...
FILE_PATH = "C:/Users/Ravi/Documents/big data assignments/Kafka/restaurant_orders.csv"
columns = ['order_number', 'order_date', 'item_name', 'quantity', 'product_price', 'total_products']

API_KEY = 'SELNYHIONWTHG47K'
ENDPOINT_SCHEMA_URL  = 'https://psrc-8kz20.us-east-2.aws.confluent.cloud'
API_SECRET_KEY = 'ObJtyAIaUx+Bb/OKxCtahpMH/VqI64U3M02hqZPzw+DW4cW8cQz7nZX5dSta6e7l'
BOOTSTRAP_SERVER = 'pkc-6ojv2.us-west4.gcp.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'ONRULITBGMU4DSSG'
SCHEMA_REGISTRY_API_SECRET = 'H8zziQURpqkKK/+6aejZgktX16jgBZ8+b5MNrtoMRDHB+bWv20NHCea3KRZH0JYK'
...
def main(topic):
    ...
    schema_str = schema_registry_client.get_latest_version('restaurent_take_away_data-value').schema.schema_str
...
main("restaurent_take_away_data")